          ...
          lbls.push(
            h(
              "text",
              {
                ...
                fontWeight: 700,
                fill: s.color,
                style: { fontVariantNumeric: "tabular-nums", paintOrder: "stroke", stroke: "#fff", strokeWidth: "3.5px", strokeLinejoin: "round" },
              },
              vfmt(v),
            ),
          );
    ...
    return h(
      ...
      h(
        ...
        panel(
          "Digital revenue",
          "Rp trillion / quarter",
          lineChart(ser("digitalBusinessRevenueQ"), labels, { height: 240, highlight: labels.length - 1, yfmt: (v: number) => (v / 1000).toFixed(0), vfmt: vT(), tipKey: "fin-digital" }),
          legend(ser("digitalBusinessRevenueQ")),
          () => tsvSeries(labels, ser("digitalBusinessRevenueQ")),
        ),
        ...
        panel("Operating expenses", "Rp trillion / quarter", lineChart(ser("opexQ"), labels, { height: 240, highlight: labels.length - 1, yfmt: (v: number) => (v / 1000).toFixed(0), vfmt: vT(), tipKey: "fin-opex" }), legend(ser("opexQ")), () => tsvSeries(labels, ser("opexQ"))),
        panel(
          "Total Expenses (includes depreciation & others, excludes finance cost)",
          "Rp trillion / quarter",
          lineChart(ser("expensesQ"), labels, { height: 240, highlight: labels.length - 1, yfmt: (v: number) => (v / 1000).toFixed(0), vfmt: vT(), tipKey: "fin-expenses" }),
          legend(ser("expensesQ")),
          () => tsvSeries(labels, ser("expensesQ")),
        ),
        panel("Net income (PAT)", "Rp trillion / quarter · negative = loss", lineChart(ser("patQ"), labels, { height: 240, zero: true, highlight: labels.length - 1, yfmt: (v: number) => (v / 1000).toFixed(1), vfmt: vT(), tipKey: "fin-pat" }), legend(ser("patQ")), () => tsvSeries(labels, ser("patQ"))),
